...
**全栈一体化**的小红书内容创作辅助工具。AI 辅助内容灵感、精美图文卡片渲染、智能排期管理、变现追踪、数据分析——一个平台搞定全部。

> ❗ **合规声明**：本平台定位为 **AI 创作辅助工具**，生成内容仅供参考。请融入个人真实经历后再发布，符合小红书平台规范。
...
| 能力 | 描述 |
|------|------|
| 🤖 **AI 辅助生成** | 基于 Gemini 2.5 Flash/Pro，生成创作参考初稿 |
...
- **AI生成参考初稿** — 输入主题，AI 生成标题/正文/标签/封面文案参考（需人工编辑后发布）
...
- **🔍 AI痕迹检测** — 检测内容中的AI生成痕迹，确保发布前内容自然度达标
- ❗ 所有AI生成内容均仅供参考，请融入个人真实经历后再发布
