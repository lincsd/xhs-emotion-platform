...
CARD_TYPE_STRATEGY_MAP = {
    "方法卡": {
        ...
        "content_focus": {
            "must_show": ["解题步骤(numbered)", "公式/规则", "一个完整例题"],
    ...
    "易错题卡": {
        ...
        "secondary": "挑战式",
        "fallback": "发现式",
        "rationale": "对比式最能突出'错在哪→正确是什么'的核心教学目标",
        "content_focus": {
            "must_show": ["错误示范(标红)", "正确解法(标绿)", "错因分析"],
            "nice_to_have": ["同类易错变体", "防错口诀"],
            "avoid": ["只展示正确答案不展示错误", "错因分析过长"]
        }
    },
    "计算零失误卡": {
        "primary": "递进式",
    ...
    "阅读理解卡": {
        ...
        "content_focus": {
            "must_show": ["答题步骤(numbered)", "答题模板/句式", "关键词标记法"],
    ...
    "语法辨析卡": {
        ...
        "content_focus": {
            "must_show": ["语法规则(中英双语)", "正确例句", "错误例句标记"],
            "nice_to_have": ["引导词对照表", "口诀"],
            "avoid": ["纯中文解释无英文", "例句过长"]
        }
    },
    "单词卡": {
        ...
        "secondary": "故事式",
        "fallback": "对比式",
        "rationale": "单词记忆通过联想和场景化最有效",
        "content_focus": {
            "must_show": ["单词(大字)", "释义", "例句"],
            "nice_to_have": ["词根词缀拆解", "联想图", "发音提示"],
            "avoid": ["堆砌多个单词", "例句太学术"]
        }
    },
    "考卷真题卡": {
        ...
        "content_focus": {
            "must_show": ["题目原文", "完整解答过程", "标准答案"],
            "nice_to_have": ["评分标准", "出题意图", "同类变式"],
            "avoid": ["解题步骤跳跃", "没有答案只有题目"]
        }
    },
    "知识总结卡": {
        "primary": "递进式",
