...
_BLOCK_KEYWORDS: dict[str, list[str]] = {
    ...
    # ── v10.21: 英语分年级段 Skill Schema 区块 (小学) ──
    '单词大字+插图': ['单词', '大字', '插图', 'word', 'large text', 'illustration', 'cartoon', 'center'],
    '迷你例句': ['迷你例句', '例句', 'mini sentence', 'example', 'short sentence'],
    '趣味记忆法': ['趣味记忆', '记忆法', 'fun memory', 'mnemonic', 'memory trick', 'association'],
    '句型积木区': ['句型积木', '积木', 'sentence block', 'building block', 'pattern', 'structure'],
    '示范搭建': ['示范搭建', '示范', 'demo', 'example build', 'sample', 'model sentence'],
    '小贴士': ['小贴士', '贴士', 'tip', 'hint', 'note', 'reminder'],
    '规则卡通图': ['规则卡通', '卡通', 'rule cartoon', 'cartoon', 'illustration', 'visual rule'],
    '例句泡泡': ['例句泡泡', '泡泡', 'sentence bubble', 'speech bubble', 'example'],
    '表情对错': ['表情对错', '对错', '表情', 'emoji', 'correct wrong', '✅', '❌', 'right wrong'],
    '速记口诀': ['速记口诀', '速记', '口诀', 'quick mnemonic', 'slogan', 'rhyme', 'memory'],
    'VS对决区': ['VS对决', 'VS', 'vs', 'versus', 'battle', 'compare', 'contrast'],
    '配对例句': ['配对例句', '配对', 'paired sentence', 'matching', 'example pair'],
    '秒记口诀': ['秒记口诀', '秒记', 'instant memory', 'quick tip', 'mnemonic', 'slogan'],
    '选择题钩子': ['选择题', '钩子', 'quiz hook', 'multiple choice', 'question hook'],
    '翻转揭秘区': ['翻转揭秘', '揭秘', 'flip reveal', 'answer reveal', 'truth'],
    '中心主题': ['中心主题', '主题', 'center topic', 'central theme', 'main topic', 'core'],
    '彩色分支': ['彩色分支', '分支', 'color branch', 'branch', 'mind map', 'radial'],
    '易错闪光': ['易错闪光', '易错', 'common error', 'highlight', 'warning', 'trap', '⚠️'],
    '漫画分镜区': ['漫画分镜', '漫画', '分镜', 'comic', 'panel', 'strip', 'scene', 'storyboard'],
    '替换词框': ['替换词', '替换', 'substitute word', 'replacement', 'variation', 'swap'],
    '模仿提示': ['模仿提示', '模仿', 'imitation', 'follow', 'practice prompt'],
    '字母/发音大字': ['字母', '发音', '大字', 'letter', 'phonics', 'pronunciation', 'large'],
    '配图例词': ['配图例词', '配图', '例词', 'illustrated word', 'picture word', 'image'],
    '找一找': ['找一找', '找', 'find', 'spot', 'search', 'interactive'],
    '挑战关卡标题': ['挑战关卡', '关卡', 'challenge', 'level', 'stage'],
    '嘴型对比区': ['嘴型对比', '嘴型', 'mouth shape', 'lip', 'pronunciation compare'],
    '闯关练习': ['闯关练习', '闯关', 'challenge practice', 'exercise', 'drill'],
    '闯关口诀': ['闯关口诀', '口诀', 'challenge mnemonic', 'slogan', 'rhyme'],
    # ── v10.21: 英语分年级段 Skill Schema 区块 (初中) ──
    '单词中心区': ['单词中心', '中心区', 'word center', 'central word', 'focus word', 'vocabulary'],
    '用法卫星区': ['用法卫星', '卫星区', 'usage satellite', 'usage pattern', 'collocation', 'usage'],
    '误用对比': ['误用对比', '误用', 'misuse compare', 'wrong usage', '❌', '✅', 'error contrast'],
    '词根速记': ['词根速记', '词根', 'root memory', 'word root', 'etymology', 'prefix', 'suffix'],
    '句型公式框': ['句型公式', '公式框', 'sentence formula', 'formula box', 'pattern', 'structure'],
    '三变区': ['三变区', '三变', 'three forms', 'transformation', 'affirmative negative question'],
    '中式英语陷阱': ['中式英语', '陷阱', 'Chinglish', 'Chinese English', 'L1 interference', 'trap'],
    '考点口诀': ['考点口诀', '考点', 'exam mnemonic', 'test point', 'exam tip', 'slogan'],
    '语法图示区': ['语法图示', '图示', 'grammar diagram', 'grammar visual', 'illustration'],
    '信号词+例句': ['信号词', '例句', 'signal word', 'keyword', 'indicator', 'example sentence'],
    '中考陷阱': ['中考陷阱', '中考', '陷阱', 'exam trap', 'test trap', 'pitfall'],
    '速记公式条': ['速记公式', '公式条', 'quick formula', 'formula strip', 'mnemonic'],
    'VS标题': ['VS标题', 'VS', 'vs title', 'versus', 'comparison title'],
    '三维对比区': ['三维对比', '三维', '3D compare', 'multi-dimension', 'meaning form usage'],
    '中考陷阱题': ['中考陷阱题', '陷阱题', 'exam trap question', 'test trap', 'trick question'],
    '区分口诀': ['区分口诀', '区分', 'distinction mnemonic', 'differentiate', 'slogan'],
    '紧迫标题': ['紧迫标题', '紧迫', 'urgent title', 'exam alert', 'attention'],
    '真题区': ['真题区', '真题', 'real exam', 'past paper', 'test question', 'exam'],
    '全选项解析': ['全选项解析', '选项', '解析', 'full option analysis', 'A B C D', 'explanation'],
    '防错口诀': ['防错口诀', '防错', 'error prevention', 'avoid mistake', 'mnemonic'],
    '对比标题': ['对比标题', 'compare title', 'vs title', 'contrast'],
    '结构双栏': ['结构双栏', '双栏', 'two column structure', 'side by side', 'dual column'],
    '真题验证': ['真题验证', '验证', 'exam verify', 'real test', 'proof'],
    '速记条': ['速记条', '速记', 'quick memory strip', 'mnemonic bar', 'formula'],
    '专题中心': ['专题中心', '专题', 'topic center', 'theme center', 'focus'],
    '知识分支网': ['知识分支', '分支网', 'knowledge branch', 'mind map', 'network', 'radial'],
    '易错红灯': ['易错红灯', '红灯', 'error red light', 'warning', 'common mistake', '⚠️'],
    '真题速练': ['真题速练', '速练', 'quick exam practice', 'drill', 'real test', 'exercise'],
    '漫画分镜': ['漫画分镜', '漫画', 'comic panel', 'strip', 'scene', 'storyboard'],
    '功能句型框': ['功能句型', '句型框', 'functional pattern', 'sentence frame', 'template'],
    '替换练习': ['替换练习', '替换', 'substitution', 'practice', 'variation', 'drill'],
    '交际口诀': ['交际口诀', '交际', 'communication mnemonic', 'dialogue tip', 'slogan'],
    '时间轴大图': ['时间轴', '大图', 'timeline', 'large diagram', 'chronological', 'time'],
    '结构公式区': ['结构公式', '公式区', 'structure formula', 'formula zone', 'pattern'],
    '信号词标签贴': ['信号词', '标签贴', 'signal word tag', 'keyword label', 'indicator'],
    '例句+陷阱': ['例句', '陷阱', 'sentence and trap', 'example trap', 'pitfall'],
    'PK大屏': ['PK大屏', 'PK', 'battle screen', 'versus', 'challenge', 'quiz'],
    '揭晓解析': ['揭晓解析', '揭晓', 'reveal analysis', 'answer explanation', 'solution'],
    '举一反三': ['举一反三', 'extend', 'apply', 'generalize', 'variation', 'more examples'],
    '判断口诀': ['判断口诀', '判断', 'judgment mnemonic', 'decision rule', 'slogan'],
    '规则超大字': ['规则超大字', '超大字', 'rule large text', 'big rule', 'prominent'],
    '验证例句': ['验证例句', '验证', 'verify sentence', 'proof sentence', 'example'],
    '易错红旗': ['易错红旗', '红旗', 'error red flag', 'warning', '⚠️', 'common mistake'],
    '发音挑战点': ['发音挑战', '挑战', 'pronunciation challenge', 'phonics', 'sound'],
    '音标对比区': ['音标对比', '音标', 'phonetic compare', 'IPA', 'sound contrast', 'pronunciation'],
    '规则+练习': ['规则', '练习', 'rule and practice', 'exercise', 'drill'],
    # ── v10.21: 英语分年级段 Skill Schema 区块 (高中) ──
    '词根拆解图': ['词根拆解', '拆解', 'root breakdown', 'word root', 'prefix', 'suffix', 'etymology'],
    '词族网络+多义': ['词族网络', '多义', 'word family', 'network', 'polysemy', 'multiple meaning'],
    '写作升级对比': ['写作升级', '升级对比', 'writing upgrade', 'level up', 'comparison'],
    '速记+真题': ['速记', '真题', 'mnemonic exam', 'quick memory test', 'real paper'],
    '句型结构图': ['句型结构', '结构图', 'sentence structure', 'diagram', 'syntax', 'parse'],
    '高考真题区': ['高考真题', '高考', 'gaokao', 'college entrance', 'real exam', 'past paper'],
    '写作升级': ['写作升级', '写作', 'writing upgrade', 'composition', 'essay improvement'],
    '仿写模板': ['仿写模板', '仿写', 'writing template', 'model sentence', 'follow pattern'],
    '语法体系图': ['语法体系', '体系图', 'grammar system', 'system diagram', 'overview'],
    '真题剖析': ['真题剖析', '剖析', 'exam analysis', 'detailed analysis', 'breakdown'],
    '写作运用': ['写作运用', '运用', 'writing application', 'practical use', 'apply'],
    '速查公式': ['速查公式', '速查', 'quick reference', 'formula lookup', 'cheat sheet'],
    '语义光谱区': ['语义光谱', '光谱', 'semantic spectrum', 'meaning range', 'nuance'],
    '深度对比区': ['深度对比', '深度', 'deep comparison', 'in-depth contrast', 'detailed vs'],
    '高考真题': ['高考真题', '高考', 'gaokao', 'real exam', 'past paper', 'actual test'],
    '辨析口诀': ['辨析口诀', '辨析', 'discrimination mnemonic', 'distinguish', 'slogan'],
    '高考钩子': ['高考钩子', '钩子', 'gaokao hook', 'exam hook', 'attention grab'],
    '真题展示': ['真题展示', '展示', 'exam display', 'show', 'present', 'real test'],
    '全选项分析': ['全选项分析', '选项', 'full option analysis', 'A B C D', 'answer analysis'],
    '高考口诀': ['高考口诀', 'gaokao mnemonic', 'exam slogan', 'test tip'],
    '体系信息图': ['体系信息图', '信息图', 'system infographic', 'overview chart', 'summary'],
    '写作提分点': ['写作提分', '提分', 'writing scoring', 'score boost', 'improvement point'],
    '高考陷阱清单': ['高考陷阱', '清单', 'gaokao trap list', 'checklist', 'common pitfall'],
    '经典真题': ['经典真题', '经典', 'classic exam', 'famous question', 'typical test'],
    '词根拆解': ['词根拆解', '词根', 'root breakdown', 'etymology', 'prefix suffix'],
}
